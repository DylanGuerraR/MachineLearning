...
CREATE OR REPLACE TABLE `future-loader-433707-h4.leads.cleaned_historic` AS
SELECT
...
FROM
    `future-loader-433707-h4.leads.historico_sintetico`;
"""
...
CREATE OR REPLACE TABLE `future-loader-433707-h4.leads.cleaned_historic` AS
SELECT DISTINCT * 
FROM `future-loader-433707-h4.leads.cleaned_historic`;
"""
...
FROM
    `future-loader-433707-h4.leads.cleaned_historic`;
"""
...
FROM `future-loader-433707-h4.leads.cleaned_hitoric`;
"""

query_validacion_estadisticas = """
SELECT
    COUNT(*) AS total_rows,
    COUNT(DISTINCT `Lead Number`) AS unique_historic,
