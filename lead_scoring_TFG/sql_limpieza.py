...
# Se divide el dataset en dos tablas:
# - 'training_set' (80% de los datos) para entrenar el modelo ML.
# - 'test_set' (20% de los datos) para validar el modelo.
...
consultas = [
    ...
    query_dividir_datasets    # Paso 6: Dividir en conjuntos de entrenamiento y prueba
]
